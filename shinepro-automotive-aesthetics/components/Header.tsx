      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-20">
        ...
        <div className="flex items-center">
          <div className="relative">
            <img src="https://i.ibb.co/fDb0Gz8/image.png" alt="Logo ShinePro" className="h-16 w-16 rounded-full border-2 border-shinepro-gold object-cover" />
            {/* Elemento decorativo no logo */}
            <span className="absolute -top-1 -right-2 text-shinepro-gold text-2xl font-bold">²</span>
          </div>
        </div>
        {/* Navegação */}
